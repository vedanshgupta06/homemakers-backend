...
public class Booking {
    ...
    public WalletConsentStatus getWalletConsentStatus() { return walletConsentStatus; }
    public void setWalletConsentStatus(WalletConsentStatus walletConsentStatus) { this.walletConsentStatus = walletConsentStatus; }

    public Double getWalletEligible() { return walletEligible; }
    public void setWalletEligible(Double walletEligible) { this.walletEligible = walletEligible; }
}