...
public class ProviderRegisterRequest {
    ...
    // ── geo fields (optional at registration, can be set later) ──
    private Double homeLatitude;
    private Double homeLongitude;
    private Integer travelRadiusKm;           // defaults to 10 if not provided
    private Boolean willingToTravel;          // defaults to false
    private Set<String> serviceablePincodes;  // optional — auto-computed if null
